...
INSERT INTO `host_instance` (`host_id`, `host_ip`, `host_name`, `host_type`, `host_project`, `is_remove`, `comment`) VALUES
	(1, '127.0.0.1', '测试主机', '1', '1', NULL, NULL);
...
-- 正在导出表  xlauto.sys_code 的数据：~2 rows (大约)
