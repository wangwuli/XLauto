...
例子
"""
obj_sysparam = "0000000000.00|3600|0000000000000000000000000000000"
dingtalk_corpid = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
dingtalk_corpsecret = "ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss"

def job_sync_department_info():
    dingtalk = Dingtalk(dingtalk_corpid, dingtalk_corpsecret)
    res = dingtalk.get_all_department(only_get_id=False)
    for dpt in res:
        if 'parentid' in dpt:
            department_pid = dpt['parentid']
        else:
            department_pid = ''
        dpt_dict = {
            'dingtalk_department_id': dpt['id'],
...
class Dingtalk(object):
    ...
    def __gettoken(self):
        ...
        try:
            ...
            dingtalk_token_info = obj_sysparam
        ...
        def __set_token():
            ...
            obj_sysparam = dingtalk_token_info
